  ...
  export default {
    ...
    created() {
      this.cities.forEach(a => {
        this.tabs.section.item.city.items.push({text: a.name, value: a.id})
      })
      this.category.forEach(a => {
        this.tabs.section.item.type.items.push({text: a.name, value: a.id})
      })
    },
    components: {
    ...
    methods: {
      async createAd() {
        ...
        this.tabs.section.item.type.model.forEach(type => {
          formData.append('type', type);
        })
        formData.append('city_id', this.tabs.section.item.city.model);
